/*	Dynamic SQL: Applications, Performance, and Security
	...
	This TSQL provides a variety of methods for creating searches using dynamic SQL.
*/
USE AdventureWorks2014 -- Can use any AdventureWorks database for all demos in this book.
GO
-- Example of a search stored procedure that uses no dynamic SQL
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Similar search, but with a dynamic WHERE clause.
CREATE PROCEDURE dbo.search_products
	@product_name NVARCHAR(50) = NULL, @product_number NVARCHAR(25) = NULL, @product_model NVARCHAR(50) = NULL,
	@product_subcategory NVARCHAR(50) = NULL, @product_sizemeasurecode NVARCHAR(50) = NULL,
	@product_weightunitmeasurecode NVARCHAR(50) = NULL
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Similar search with dynamic SELECT, FROM, and WHERE clauses.
CREATE PROCEDURE dbo.search_products
	@product_name NVARCHAR(50) = NULL, @product_number NVARCHAR(25) = NULL, @product_model NVARCHAR(50) = NULL,
	@product_subcategory NVARCHAR(50) = NULL, @product_sizemeasurecode NVARCHAR(50) = NULL,
	@product_weightunitmeasurecode NVARCHAR(50) = NULL,
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Searching based on the form of the input string
CREATE PROCEDURE dbo.search_sales_order_detail
...
EXEC dbo.search_sales_order_detail @input_search_data = 'PO12557127067';
...
EXEC dbo.search_sales_order_detail @input_search_data = '52FF-45CD-9B', @offset_by_this_many_rows = 0, @row_count_to_return = 50, @return_all_results = 0;
EXEC dbo.search_sales_order_detail @input_search_data = '10-4020-000646';
EXEC dbo.search_sales_order_detail @input_search_data = 'SO43662', @return_all_results = 1;
GO
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Retrieve the count of rows prior to data collection.  This can be returned as a separate parameter,
-- included in the main data set later on, or handled in a completely separate function/stored procedure.
SELECT
	COUNT(*)
FROM Sales.SalesOrderHeader
INNER JOIN Sales.SalesOrderDetail
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Retrieve the current row count as well as the total row count alongside the data above
SELECT
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Using a CTE, return the same counts as above, but allowing for paging below.
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Use dynamic SQL to leave out the extra counts, as needed:
...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- Returning SUM/COUNT based on input parameters.
